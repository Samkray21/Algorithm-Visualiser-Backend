package com.algorithm.Algorithm.SpanningTreeAlgorithms.Boruvka;
...
public class BoruvkaMST {
    ...
    private  MutableValueGraph<Integer, Integer> mst = ValueGraphBuilder.undirected()
            .build();
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (edge != null) {
                    ...
                    if (uf.find(u) != uf.find(v)) {
                        ...
                        finalKGraph.add(convert.convertNumToString(u) + convert.convertNumToString(v));
                    }
                }
            }
        }
